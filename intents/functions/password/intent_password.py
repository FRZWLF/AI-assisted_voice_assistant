...
def getPassword(session_id = "general", entry="none"):
    ...
    db_file = constants.find_data_file(os.path.join('intents','functions','password',db_file))
    key_file = constants.find_data_file(os.path.join('intents','functions','password',key_file))
